...
.method constructor <init>(Landroid/view/View;Landroid/transition/Transition;Landroid/view/View;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Landroid/transition/Transition;Ljava/util/ArrayList;Ljava/util/Map;Ljava/util/ArrayList;Landroid/transition/Transition;)V
    ...
    iput-object p4, p0, Landroid/support/v4/app/ar;->d:Ljava/util/ArrayList;

    iput-object p5, p0, Landroid/support/v4/app/ar;->e:Landroid/transition/Transition;

    iput-object p6, p0, Landroid/support/v4/app/ar;->f:Ljava/util/ArrayList;

    iput-object p7, p0, Landroid/support/v4/app/ar;->g:Landroid/transition/Transition;

    iput-object p8, p0, Landroid/support/v4/app/ar;->h:Ljava/util/ArrayList;

    iput-object p9, p0, Landroid/support/v4/app/ar;->i:Ljava/util/Map;

    iput-object p10, p0, Landroid/support/v4/app/ar;->j:Ljava/util/ArrayList;

    iput-object p11, p0, Landroid/support/v4/app/ar;->k:Landroid/transition/Transition;
...
.method public final onPreDraw()Z
    ...
    iget-object v1, p0, Landroid/support/v4/app/ar;->d:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/an;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    .line 289
    :cond_0
    iget-object v0, p0, Landroid/support/v4/app/ar;->e:Landroid/transition/Transition;
    ...
    .line 292
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/ar;->g:Landroid/transition/Transition;
    ...
    iget-object v1, p0, Landroid/support/v4/app/ar;->h:Ljava/util/ArrayList;

    invoke-static {v0, v1}, Landroid/support/v4/app/an;->a(Ljava/lang/Object;Ljava/util/ArrayList;)V

    .line 295
    :cond_2
    iget-object v0, p0, Landroid/support/v4/app/ar;->i:Ljava/util/Map;
    ...
    .line 300
    :cond_3
    iget-object v0, p0, Landroid/support/v4/app/ar;->j:Ljava/util/ArrayList;
    ...
    .line 302
    iget-object v4, p0, Landroid/support/v4/app/ar;->k:Landroid/transition/Transition;
    ...
    .line 304
    :cond_4
    iget-object v0, p0, Landroid/support/v4/app/ar;->k:Landroid/transition/Transition;
