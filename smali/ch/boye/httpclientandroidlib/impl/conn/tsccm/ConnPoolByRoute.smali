...
.method protected getEntryBlocking(Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThreadAborter;)Lch/boye/httpclientandroidlib/impl/conn/tsccm/BasicPoolEntry;
    ...
    .line 337
    iget-object v5, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-virtual {p0, v0, v5}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->getRoutePool(Lch/boye/httpclientandroidlib/conn/routing/HttpRoute;Z)Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;
    ...
    .line 345
    iget-boolean v5, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->shutdown:Z
    ...
    iget-object v9, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->freeConnections:Ljava/util/Queue;
    ...
    iget-object v9, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->leasedConnections:Ljava/util/Set;
    ...
    iget v9, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->numConnections:I
    ...
    iget v9, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->maxTotalConnections:I
    ...
    invoke-virtual {p0, v8, v0}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->getFreeEntry(Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;Ljava/lang/Object;)Lch/boye/httpclientandroidlib/impl/conn/tsccm/BasicPoolEntry;
    ...
    .line 363
    invoke-virtual {v8}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;->getCapacity()I
    ...
    .line 368
    :goto_1
    iget-object v9, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->log:Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;

    invoke-virtual {v9}, Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;->isDebugEnabled()Z
    ...
    invoke-virtual {v8}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;->getMaxEntries()I
    ...
    invoke-virtual {v9, v10}, Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;->debug(Ljava/lang/Object;)V
    ...
    iget v10, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->maxTotalConnections:I

    if-ge v9, v10, :cond_5

    .line 376
    iget-object v5, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->operator:Lch/boye/httpclientandroidlib/conn/ClientConnectionOperator;

    invoke-virtual {p0, v8, v5}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->createEntry(Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;Lch/boye/httpclientandroidlib/conn/ClientConnectionOperator;)Lch/boye/httpclientandroidlib/impl/conn/tsccm/BasicPoolEntry;
    ...
    .line 384
    iget-object v6, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->operator:Lch/boye/httpclientandroidlib/conn/ClientConnectionOperator;

    invoke-virtual {p0, v5, v6}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->createEntry(Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;Lch/boye/httpclientandroidlib/conn/ClientConnectionOperator;)Lch/boye/httpclientandroidlib/impl/conn/tsccm/BasicPoolEntry;
    ...
    invoke-virtual {v6, v9}, Lch/boye/httpclientandroidlib/androidextra/HttpClientAndroidLog;->debug(Ljava/lang/Object;)V
    ...
    .line 394
    iget-object v6, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->poolLock:Ljava/util/concurrent/locks/Lock;

    invoke-interface {v6}, Ljava/util/concurrent/locks/Lock;->newCondition()Ljava/util/concurrent/locks/Condition;

    move-result-object v6

    invoke-virtual {p0, v6, v8}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->newWaitingThread(Ljava/util/concurrent/locks/Condition;Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;)Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThread;
    ...
    invoke-virtual {v0, v6}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThreadAborter;->setWaitingThread(Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThread;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_2
    :try_start_2
    invoke-virtual {v8, v6}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;->queueThread(Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThread;)V

    .line 402
    iget-object v7, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->waitingThreads:Ljava/util/Queue;

    invoke-interface {v7, v6}, Ljava/util/Queue;->add(Ljava/lang/Object;)Z

    .line 403
    invoke-virtual {v6, v4}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThread;->await(Ljava/util/Date;)Z
    :try_end_2
    ...
    .line 410
    :try_start_3
    invoke-virtual {v8, v6}, Lch/boye/httpclientandroidlib/impl/conn/tsccm/RouteSpecificPool;->removeThread(Lch/boye/httpclientandroidlib/impl/conn/tsccm/WaitingThread;)V

    .line 411
    iget-object v9, p0, Lch/boye/httpclientandroidlib/impl/conn/tsccm/ConnPoolByRoute;->waitingThreads:Ljava/util/Queue;
    ...
    .line 417
    new-instance v4, Lch/boye/httpclientandroidlib/conn/ConnectionPoolTimeoutException;

    const-string v5, "Timeout waiting for connection"

    invoke-direct {v4, v5}, Lch/boye/httpclientandroidlib/conn/ConnectionPoolTimeoutException;-><init>(Ljava/lang/String;)V
